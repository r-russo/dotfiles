...
awful.screen.connect_for_each_screen(function(s)
    ...
    tags = {
        settings = {
            { names = {"www", "editor", "music", "steam", "5", "6"},
                layout = { layouts[2], layouts[1], layouts[2], layouts[2], layouts[1], layouts[1]}
            },
            { names = {"www", "telegram", "other"},
                layout = { layouts[2], layouts[2], layouts[2]}
            }
        }}
    -- awful.tag({ "term", "firefox", "spotify", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({"Shift"}, "Print", function () awful.spawn.with_shell("/home/russo/.local/bin/screen_region") end),
    awful.key({"Mod1"}, "Print", function () awful.spawn.with_shell("/home/russo/.local/bin/screen_active") end)
)
...
awful.rules.rules = {
    ...
    { rule = { class = "TelegramDesktop" }, properties = { screen = 2, tag = "telegram" } },
...
awful.spawn.with_sehll("lxpolkit")
